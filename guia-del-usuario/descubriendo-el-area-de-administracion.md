...
* [Descubriendo el Área de Administración](descubriendo-el-area-de-administracion.md#descubriendo-el-area-de-administracion)
  * [Visión general de la interfaz principal](descubriendo-el-area-de-administracion.md#vision-general-de-la-interfaz-principal)
    * [La barra superior](descubriendo-el-area-de-administracion.md#la-barra-superior)
    * [Los menús](descubriendo-el-area-de-administracion.md#los-menus)
  * [Los botones](descubriendo-el-area-de-administracion.md#los-botones)
  * [Ayuda contextual](descubriendo-el-area-de-administracion.md#ayuda-contextual)
  * [El cuadro de mandos](descubriendo-el-area-de-administracion.md#el-cuadro-de-mandos)
    * [La cabecera y el modo demo](descubriendo-el-area-de-administracion.md#la-cabecera-y-el-modo-demo)
    * [La barra horizontal](descubriendo-el-area-de-administracion.md#la-barra-horizontal)
    * [La columna izquierda](descubriendo-el-area-de-administracion.md#la-columna-izquierda)
    * [La columna central](descubriendo-el-area-de-administracion.md#la-columna-central)
    * [La columna derecha](descubriendo-el-area-de-administracion.md#la-columna-derecha)
...
![](../.gitbook/assets/54888015.png)

#### La barra superior

![](../.gitbook/assets/54264913.png)
...
* **Inicio**. La página principal del back-office, donde puedes ver las estadísticas principales, en tiempo real.![](../.gitbook/assets/54888017.png)
...
![](../.gitbook/assets/54264922.png)De manera predeterminada, esta columna te muestra datos del **módulo Panel de actividad**, el cual ofrece las principales cifras estadísticas de la base de datos de tu tienda, de manera que puedas revisarlas y valorarlas de un simple vistazo: 
...
* **Productos y ventas** \(Módulo Panel de Productos\). Este bloque presenta una tabla con tus últimos pedidos y un ranking de tus productos: los más vendidos, los más vistos y los más buscados \(recogidos desde el propio buscador de tu tienda, y no desde los motores de búsqueda\).![](../.gitbook/assets/54264936.png)Puedes establecer el número de elementos a mostrar en cada una de ellas abriendo el formulario de configuración del bloque.
