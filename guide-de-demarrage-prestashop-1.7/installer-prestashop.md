...
* [Installer PrestaShop](installer-prestashop.md#InstallerPrestaShop-InstallerPrestaShop)
  * [Instructions d’installation rapides](installer-prestashop.md#instructions-dinstallation-rapides)
  * [Instructions détaillées](installer-prestashop.md#instructions-detaillees)
    * [Télécharger et décompresser l’archive de PrestaShop](installer-prestashop.md#telecharger-et-decompresser-larchive-de-prestashop)
    * [Mettre PrestaShop en ligne](installer-prestashop.md#mettre-prestashop-en-ligne)
    * [Créer une base de données pour votre boutique](installer-prestashop.md#creer-une-base-de-donnees-pour-votre-boutique)
    * [Lancer l’installeur automatique](installer-prestashop.md#lancer-linstalleur-automatique)
    * [Terminer l’installation](installer-prestashop.md#terminer-linstallation)
...
## Installer PrestaShop <a id="InstallerPrestaShop-InstallerPrestaShop"></a>
